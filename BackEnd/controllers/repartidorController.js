...
// 4. Obtener el viaje activo que el conductor trae actualmente en ruta
...
// 5. Obtener repartidores que tienen dinero en efectivo pendiente de liquidar
...
// 6. Obtener el desglose exacto de los pedidos en efectivo de un repartidor específico
...
// 7. Transacción Segura: Liquidar el dinero y asentar los folios en BD
exports.liquidarAuditoria = async (req, res) => {
  ...
  try {
    // Iniciamos una transacción SQL manual para asegurar la consistencia financiera
    await db.query('BEGIN');

    // Cambiamos el estado de los pedidos a "Liquidado"
    const updateQuery = `
      UPDATE pedidos
