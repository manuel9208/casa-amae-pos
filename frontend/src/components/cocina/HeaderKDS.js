...
const HeaderKDS = ({ user, onLogout, filtroTab, setFiltroTab, setModalInsumo, setModalMerma, setModalAsistencia, configGlobal = {} }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between bg-slate-800 p-4 rounded-3xl shadow-md border border-slate-700 mb-8 gap-4 print:hidden">
      ...
      <div className="flex items-center gap-4">
        ...
        {/* 👇 MOSTRAR BOTONES SOLO SI ESTÁ ACTIVADO */}
        {isAsistenciaPin && (
      ...
      <button onClick={onLogout} className="flex items-center justify-center gap-2 text-slate-400 hover:text-white bg-slate-900 px-6 py-3 rounded-xl font-bold transition border border-slate-700 active:scale-95">
