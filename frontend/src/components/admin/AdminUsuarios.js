...
import { Users, Sparkles, History, DollarSign, MessageSquare, Calendar, ClipboardCheck } from 'lucide-react';
...
const AdminUsuarios = ({ usuariosDB, apiUrl, refrescarDatos, showAlert, showConfirm, user }) => {
    ...
    return (
        <div className="max-w-[1400px] w-full mx-auto space-y-8 pb-12 animate-in fade-in px-4">
            ...
            {vista === 'calendario' && <GestorCalendarioAnual usuariosDB={usuariosDB} configGlobal={configGlobal} setConfigGlobal={setConfigGlobal} apiUrl={apiUrl} showAlert={showAlert} refrescarDatos={refrescarDatos} />}
