...
import { Trash2, Gift, ArrowUpRight, Tag, Clock } from 'lucide-react';

const ListaPromociones = ({ promociones, apiUrl, showAlert, showConfirm, refrescarDatos, isSubmitting }) => {
