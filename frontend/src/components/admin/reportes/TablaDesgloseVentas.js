                        ...
                        <table className="w-full text-left border-collapse">
                                ...
                                {ventasNormales.map((p, i) => {
                                    ...
                                    return (
                                        <tr key={i} className={`transition print:hover:bg-transparent ${isExtra ? 'bg-emerald-50/30' : isEnvio ? 'bg-purple-50/30' : 'hover:bg-slate-50'}`}>
                                            ...
                                            <td className="p-4 font-medium text-orange-500 text-right print:p-2 print:text-sm">
                            ...
                            <tfoot>
                                <tr className="bg-slate-800 text-white print:bg-slate-200 print:text-black border-t-4 border-slate-900 print:border-black">
                                    ...
                                    <td className="p-4 font-black text-orange-400 text-right text-lg print:p-2 print:text-sm print:text-orange-700">-{formaterMoneda(totalesNormales.descuentosTotales)}</td>
                                    <td className="p-4"></td>
