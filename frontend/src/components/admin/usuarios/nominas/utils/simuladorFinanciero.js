...
export const calcularSimulacionFinanciera = (plantillaSemanal, sueldoBase, tipoSueldo) => {
    ...
    // 👇 LA MAGIA: Simplificamos para que Semanal/Quincenal sea exacto
    switch (tipoSueldo) {
        case 'Mensual': 
        ...
        case 'Semanal': 
            ...
            sueldoDiarioReal = base / 7; // LFT: Una semana siempre tiene 7 días financieros
            break;
        case 'Por Día': 
        case 'Diario': 
