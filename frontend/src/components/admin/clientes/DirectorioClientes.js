...
import { Search, PlusCircle, Edit2, Trash2, MapPin, Key } from 'lucide-react';  
...
// 🛡️ CORRECCIÓN: Agregamos "direccion" y "nip" al estado inicial
const [formData, setFormData] = useState({
nombre: '', apellido: '', telefono: '', correo: '', fecha_nacimiento: '', direccion: '', nip: ''
});  
...
setFormData({ nombre: '', apellido: '', telefono: '', correo: '', fecha_nacimiento: '', direccion: '', nip: '' });
...
nip: c.nip || '' // 👇 FIX: Carga el NIP para poder verlo o editarlo
});
setModalCliente(true);
};  
...
<td className="py-3 px-2">
  ...
  {/* 👇 FIX APLICADO: Badge visible del NIP debajo del nombre */}
...
{/* 👇 FIX APLICADO: Fechas y NIP en la misma cuadrícula */}
<div className="grid grid-cols-2 gap-4">
