  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-8 animate-in fade-in pb-12 px-4">
      <div className="flex items-center gap-3 mb-2">
        ...
        <div>
          <h2 className="text-3xl font-black text-slate-800">Marketing y Promociones</h2>
          <p className="text-slate-500 font-medium">Configura reglas automáticas, cupones y puntos para aumentar tu ticket promedio.</p>
        </div>
      </div>  
