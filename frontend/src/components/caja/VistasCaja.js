...
const VistasCaja = (props) => {
    ...
    const liberarMesaMagicamente = async (numero_mesa, pedido_id = null) => {
        try {
            const tableObj = props.mesas.find(m => String(m.numero_mesa) === String(numero_mesa));
            if (tableObj) {
            ...
            <div className="flex-1 p-4 md:p-10">
                ...
                {vistaActiva === 'corte' && (
                    <VistaCorte
                        ...
                        fondoRepartidor={fondoRepartidorGlobal} user={user}
