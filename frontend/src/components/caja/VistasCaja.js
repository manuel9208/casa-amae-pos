...
const VistasCaja = (props) => {
  ...
  // 👇 MANTENEMOS TUS VARIABLES ORIGINALES EXACTAMENTE IGUAL
  let totalPlatillos = 0; let totalExtras = 0; let totalEnvio = 0;
  
  // 👇 AGREGAMOS LAS EXCLUSIVAS DE DOMICILIO SIN ROMPER LAS TUYAS
  ...
  pedidosValidos.forEach(p => {
    ...
    // Desglose de pagos solo para domicilio
    if (isDomicilio) {
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-slate-50 relative">
      ...
      <div className="flex-1 p-4 md:p-10">
        ...
        {vistaActiva === 'historial' && <VistaHistorial pedidos={pedidos} subVistaHistorial={props.subVistaHistorial} setSubVistaHistorial={props.setSubVistaHistorial} isSubmitting={isSubmitting} limpiandoMesas={limpiandoMesas} getTelefonoExtraido={getTelefonoExtraido} renderBotonVerDetalle={renderBotonVerDetalle} configGlobal={props.configGlobal} lanzarImpresion={props.lanzarImpresion} />}
        ...
        {/* 👇 AQUÍ LE PASAMOS TODO INTACTO A VISTACORTE, MÁS LOS DATOS DE DOMICILIO */}
        {vistaActiva === 'corte' && (
          <VistaCorte 
