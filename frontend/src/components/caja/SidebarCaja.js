...
import { DollarSign, CheckCircle2, XCircle, ShoppingBag, Monitor, List, FileText, LogOut, Phone, ShoppingCart, PlusCircle, X } from 'lucide-react'; // 👇 Se agregó el ícono 'X'
...
const SidebarCaja = ({ 
  ...
  abrirIdentificador,
  menuAbiertoCaja, setMenuAbiertoCaja // 👇 NUEVAS PROPS: Control del menú responsivo
}) => {
  
  // Función auxiliar para navegar y cerrar el menú en móviles al mismo tiempo
