...
const TopNavCaja = ({
  ...
  mesasPagadas, setModalCompraRapida, abrirIdentificador, pedidosEnReparto, setModalAsistencia // 👈 NUEVO PROP AÑADIDO AQUÍ
}) => {  
    ...
    <div className="bg-white border-b border-slate-200 shadow-sm z-40 shrink-0 flex flex-col w-full animate-in fade-in">  
      <div className="flex flex-wrap items-center justify-between px-6 py-4 gap-4">  
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">  
          ...
          {/* 👇 CONTENEDOR DERECHO ACTUALIZADO CON LOS BOTONES DE ASISTENCIA */}
