                ...
                <div className="flex items-center justify-between lg:justify-start gap-4 md:gap-6 w-full lg:w-auto">
                    ...
                    {configGlobal && (
                        <button
                            ...
                            className={`flex items-center gap-1.5 md:gap-2 px-3 md:px-4 py-2 rounded-xl font-black text-[10px] md:text-xs uppercase tracking-widest transition-all shadow-sm active:scale-95 shrink-0 ${
