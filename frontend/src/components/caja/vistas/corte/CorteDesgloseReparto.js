        ...
        <div className="bg-indigo-50/50 p-6 md:p-10 rounded-[40px] shadow-sm border border-indigo-100 animate-in slide-in-from-bottom-6 mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
                <div className="bg-white p-5 rounded-3xl border border-indigo-100 shadow-sm group hover:border-indigo-300 transition-all duration-200">
                    <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-1">Ventas (Dom.)</p>
                ...
                <div className="bg-white p-5 rounded-3xl border border-indigo-100 shadow-sm group hover:border-indigo-300 transition-all">
                    <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-1 flex items-center gap-1">
                        <MapPin size={12} className="text-purple-400" /> Envíos
                    </p>
                ...
                <div className="bg-white p-5 rounded-3xl border border-indigo-100 shadow-sm">
                    <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-1">Fondo</p>
                    <p className="text-xl font-black text-indigo-900">${(pFondoRepartidor || 0).toFixed(2)}</p>
                </div>
                ...
                <div className="bg-emerald-50 p-5 rounded-3xl border border-emerald-100 shadow-sm group hover:bg-emerald-100/50 transition-all">
                    <p className="text-[10px] font-black text-emerald-600 uppercase tracking-widest mb-1">Efectivo</p>
                    <p className="text-xl font-black text-emerald-700">+${(mathHoy.dEfectivo || 0).toFixed(2)}</p>
                </div>

                <div className="bg-blue-50 p-5 rounded-3xl border border-blue-100 shadow-sm group hover:bg-blue-100/50 transition-all">
                    <p className="text-[10px] font-black text-blue-600 uppercase tracking-widest mb-1">Tarjeta</p>
                    <p className="text-xl font-black text-blue-700">+${(mathHoy.dTarjeta || 0).toFixed(2)}</p>
                </div>

                <div className="bg-purple-50 p-5 rounded-3xl border border-purple-100 shadow-sm group hover:bg-purple-100/50 transition-all">
                    <p className="text-[10px] font-black text-purple-600 uppercase tracking-widest mb-1">Transf.</p>
                    <p className="text-xl font-black text-purple-700">+${(mathHoy.dTransf || 0).toFixed(2)}</p>
                </div>
            </div>
