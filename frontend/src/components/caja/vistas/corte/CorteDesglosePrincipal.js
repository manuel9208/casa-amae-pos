                ...
                {cargando ? (
                    ...
                    <div className="animate-in slide-in-from-bottom-4 duration-300">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            ...
                            {/* VENTAS BRUTAS */}
                            <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200 hover:border-slate-300 transition-colors flex flex-col">
                                ...
                                <div className="mt-3 pt-3 border-t border-slate-200 space-y-1 w-full">
                                    <div className="flex justify-between items-center text-[9px] font-bold text-slate-500">
                                        <span>Restaurante:</span>
                                        <span>${((mathHoy.tPlatillos || 0) + (mathHoy.tExtras || 0) + (mathHoy.tEnvio || 0)).toFixed(2)}</span>
                                    </div>
                                    <div className="flex justify-between items-center text-[9px] font-bold text-indigo-500">
                                        <span>Mayoreo (B2B):</span>
                                        <span>${(mathHoy.mVentas || 0).toFixed(2)}</span>
                                    </div>
                                </div>

                                {(mathHoy.tDescuentos > 0) && (
                                    <p className="text-[10px] font-bold text-orange-500 mt-2 border-t border-slate-200 pt-1">
                            ...
                            {/* INGRESOS EFECTIVO */}
                            <div className="bg-emerald-50 p-5 rounded-2xl border border-emerald-100 hover:border-emerald-300 transition-colors flex flex-col">
                                ...
                                <div className="mt-3 pt-3 border-t border-emerald-200/50 space-y-1 w-full">
                                    <div className="flex justify-between items-center text-[9px] font-bold text-emerald-700/70">
                                        <span>Restaurante:</span>
                                        <span>${((mathHoy.lEfectivo || 0) + (mathHoy.dEfectivo || 0)).toFixed(2)}</span>
                                    </div>
                                    <div className="flex justify-between items-center text-[9px] font-bold text-indigo-600">
                                        <span>Mayoreo (B2B):</span>
                                        <span>${(mathHoy.mEfectivo || 0).toFixed(2)}</span>
                                    </div>
                                </div>
                            </div>  
