...
const CorteCajaFinanciero = (props) => {
        ...
        pedidosDelTurnoActivo.forEach(p => {
            ...
            car.forEach(i => {
                ...
                if (!isComedor) {
                    ...
                    if (isDomicilio) { 
                        dExt += calcExtra; dPla += calcPlat; 
                    } else { 
                        lExt += calcExtra; lPla += calcPlat; 
                    }
                }
            });
            ...
            if (!isComedor) {
                ...
                if (discount > 0) totalDescuentos += discount;
            }
        });
    ...
    // Solo restamos de "Caja" lo que es del Mostrador
    ...
    const totalDeclaradoEnVivo = efectivoDeclaradoPrevio + (Number(efectivoManual) || 0);
