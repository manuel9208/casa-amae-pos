...
const CorteDesgloseDigital = ({ mathHoy }) => {
    ...
    const granTotalDigital = totalTarjetas + totalTransferencias;

    return (
        <div className="bg-blue-50/50 p-6 md:p-8 rounded-[32px] border border-blue-100 transition-all hover:shadow-md flex flex-col h-full">
            <div className="flex justify-between items-start mb-6 border-b border-blue-100 pb-6">
                ...
                <div className="text-right">
                    ...
                    <p className="text-3xl font-black text-blue-700">${granTotalDigital.toFixed(2)}</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-auto">
                ...
                <div className="bg-white p-5 rounded-2xl border border-purple-100 shadow-sm group hover:border-purple-300 hover:shadow-md transition-all duration-300 flex flex-col justify-between">
                    ...
                    <p className="text-2xl lg:text-3xl font-black text-purple-900">
