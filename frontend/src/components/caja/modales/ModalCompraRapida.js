...
import { PackagePlus, XCircle, CheckCircle2, Search } from 'lucide-react';  
        ...
        <>
            {modalCompraRapida && !insumoComprar && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white p-8 rounded-[40px] shadow-2xl border border-slate-200 w-full max-w-4xl h-[80vh] flex flex-col animate-in zoom-in duration-200 overflow-hidden">
                        
                        <div className="flex justify-between items-center border-b pb-6 mb-6 shrink-0">
                            <div>
                        ...
                        <div className="mb-4 shrink-0 relative">
                            ...
                            <input 
                                ...
                                className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl font-bold text-slate-700 outline-none focus:border-emerald-500 transition-all"
                            />
                        </div>
                            ...
                            {insumosDB.length === 0 ? (
                                ...
                                <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-slate-100">
                                        {/* 👇 RENDERIZADO DEL ARREGLO FILTRADO */}
                                        {insumosFiltrados.map(insumo => (
                                            <tr key={insumo.id} className="hover:bg-white transition group">
                                                ...
                                                <td className="p-4 text-right">
                                                    <button
                                                        onClick={() => { setInsumoComprar(insumo); setPaquetesComprados(''); setBusqueda(''); }}
