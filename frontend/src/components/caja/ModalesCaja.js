...
import { DollarSign, CheckCircle2, XCircle, BellRing, MessageSquare, AlertTriangle, CreditCard, Smartphone, MapPin } from 'lucide-react';
...
const ModalesCaja = ({
  ...
  // 👇 Recibimos las props del nuevo modal
  ...
  // Helper para leer las tarifas seguras
  ...
  return (
    <>
      ...
      {/* 👇 NUEVO MODAL: ASIGNAR ZONA DE ENVÍO */}
      {modalZonaEnvio && (
